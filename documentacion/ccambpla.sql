...
-- -----------------------------------------------------
-- Data for table `ccambpla`.`tab_jef`
-- -----------------------------------------------------
START TRANSACTION;
USE `ccambpla`;
INSERT INTO `ccambpla`.`tab_jef` (`ident_jef`, `cedul_jef`, `nombr_jef`, `apeli_jef`, `fecna_jef`, `telem_jef`, `telec_jef`, `email_jef`, `direc_jef`, `tibom_jef`, `seria_jef`, `usuar_jef`, `contr_jef`, `statu_jef`, `ident_tip`) VALUES (1, 26607655, 'CARLOS', 'GUANIPA', '1998-03-29', '(0426) 690 8396', '(0276) 353 2978', 'GUANIPA@MAIL', 'CALLE 2 BELLAVISTA RESD MILDREY PISO 7 APTO 74', 'GRANEL', '012345678', 'AGUSTIN', '12345', '1', 1);
