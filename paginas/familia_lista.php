...
<div class="container-fluid">
	<div class="table-wrapper">
	    <div class="table-title">
	        <div class="row">
            <div class="col-sm-6">
							<h2>Administrar <b>Familias</b></h2>
						</div>
						<div class="col-sm-6">
	    ...
	    <div class="row" style="padding-top: 2px;">
	    	<div class="col-sm-8">
					<a href="familia_registro.php" class="btn btn-info float-left"><i class="fa fa-plus"></i> Registrar Jefe de Familia</a>
				</div>
				<form action="familia_buscar.php" method="GET" class="col-sm-4" style="padding-top: 1px;">
	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$query = mysqli_query($conexion,"SELECT u.ident_per, u.cedul_per,u.nombr_per, u.apeli_per, u.telem_per, u.email_per, u.usuar_per, r.ident_tip, r.nombr_tip FROM tab_per u INNER JOIN tab_tip r ON u.ident_tip = r.ident_tip WHERE statu_per = 1 AND u.tifam_per = 'JEFE DE FAMILIA' ORDER BY ident_per ASC LIMIT $desde,$por_pagina");
